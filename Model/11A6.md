...
**Name:** ```objects\weapons\pistol\plasma_pistol\plasma_pistol_scenery```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x11A7] objects\weapons\pistol\plasma_pistol\fp_plasma_pistol\fp_plasma_pistol](../RenderModel/11A7.md)
