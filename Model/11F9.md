...
**Name:** ```objects\weapons\pistol\plasma_pistol\plasma_pistol_v3_scenery```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x11FA] objects\weapons\pistol\plasma_pistol\fp_plasma_pistol\fp_plasma_pistol_v3](../RenderModel/11FA.md)
