...
**Name:** ```objects\multi\models\mp_flag_base\mp_flag_base```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x33B3] 0x000033B3](../RenderModel/33B3.md)
CollisionModel	|CachedTagInstance (CollisionModel)	|[[0x33B4] 0x000033B4](../CollisionModel/33B4.md)
Animation	|CachedTagInstance	|null
PhysicsModel	|CachedTagInstance (PhysicsModel)	|[[0x33B5] 0x000033B5](../PhysicsModel/33B5.md)
