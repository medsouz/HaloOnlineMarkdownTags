...
**Name:** ```objects\weapons\rifle\battle_rifle\battle_rifle_v2_scenery```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x0FAE] objects\weapons\rifle\battle_rifle\fp_battle_rifle\fp_battle_rifle_v2](../RenderModel/0FAE.md)
