...
**Name:** ```objects\weapons\rifle\plasma_rifle\plasma_rifle_v2_scenery```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x113F] objects\weapons\rifle\plasma_rifle\fp_plasma_rifle\fp_plasma_rifle_v2](../RenderModel/113F.md)
