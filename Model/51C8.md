...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[0x51C9](../RenderModel/51C9.md)
CollisionModel	|CachedTagInstance (CollisionModel)	|[0x51E2](../CollisionModel/51E2.md)
Animation	|CachedTagInstance	|null
PhysicsModel	|CachedTagInstance (PhysicsModel)	|[0x51E3](../PhysicsModel/51E3.md)
ReduceToL1SuperLow	|Single	|351.3696
ReduceToL2Low	|Single	|263.5272
...
DamageConstraints	|TagBlock (NewDamageInfo_DamageConstraints)	|[2](#newdamageinfo_damageconstraints)
...
Trigger	|StringId	|swing_arm
Flags	|Enum (FlagsValue)	|null
DamageThreshold	|Single	|0.2
PrimaryTransitionEffect	|CachedTagInstance (Effect)	|[[0x06B4] 0x000006B4](../Effect/06B4.md)
SecondaryTransitionEffect	|CachedTagInstance (Effect)	|[0x51E4](../Effect/51E4.md)
...
EffectMarkerName	|StringId	|spooge
...
Name	| Type	| Value
---	|---	|---	|
PhysicsModelConstraintName	|StringId	|b_hinge_arm
DamageConstraintName	|StringId	|hinge_arm
DamageConstraintGroupName	|StringId	|swing_arm
...
Name	| Type	| Value
---	|---	|---	|
PhysicsModelConstraintName	|StringId	|b_hinge_link
DamageConstraintName	|StringId	|hinge_link
DamageConstraintGroupName	|StringId	|swing_arm
GroupProbabilityScale	|Single	|1
Type	|Enum (TypeValue)	|null
Index	|Int16	|1
...
Type	|Enum (TypeValue)	|null
Unknown	|Int16	|0
Offset	|RealPoint3d	|{ X: 1.03736, Y: -0.328639, Z: 2.0495 }
