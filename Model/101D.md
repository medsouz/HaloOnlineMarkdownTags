...
**Name:** ```objects\weapons\rifle\dmr\dmr_v1_scenery```
...
Name	| Type	| Value
---	|---	|---	|
RenderModel	|CachedTagInstance (RenderModel)	|[[0x101E] objects\weapons\rifle\dmr\fp_dmr\fp_dmr_v1](../RenderModel/101E.md)
