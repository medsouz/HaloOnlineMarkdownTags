...
Model	|CachedTagInstance (Model)	|[[0x41B7] objects\characters\ambient_life\lod_pelican\lod_pelican](../Model/41B7.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x41B8] 0x000041B8](../Effect/41B8.md)
Marker	|StringId	|
...
---	|---	|---	|
AtlasFlags	|Enum (AtlasFlagsValue)	|null
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x41B9] 0x000041B9](../SoundLooping/41B9.md)
Marker	|StringId	|
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
