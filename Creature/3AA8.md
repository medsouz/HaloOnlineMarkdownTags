...
**Name:** ```objects\characters\ambient_life\seagull\seagull```
...
Model	|CachedTagInstance (Model)	|[[0x3DCB] 0x00003DCB](../Model/3DCB.md)
...
TurningVelocityMaximum	|Angle	|{ Degrees: 180, Radians: 3.141593 }
TurningAccelerationMaximum	|Angle	|{ Degrees: 360, Radians: 6.283185 }
