...
Model	|CachedTagInstance (Model)	|[0x49A2](../Model/49A2.md)
...
Attachment2	|CachedTagInstance (SoundLooping)	|[0x49B7](../SoundLooping/49B7.md)
Marker	|StringId	|
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
PrimaryScale	|StringId	|compass
