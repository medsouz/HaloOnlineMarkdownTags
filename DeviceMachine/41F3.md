...
**Name:** ```objects\levels\multi\s3d_turf\fabric_01_moving\fabric_01_moving```
...
BoundingRadius	|Single	|1.777779
BoundingOffset	|RealPoint3d	|{ X: 0.9924393, Y: -0.07442577, Z: -0.9283276 }
...
Model	|CachedTagInstance (Model)	|[[0x43B1] 0x000043B1](../Model/43B1.md)
...
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x43B2] 0x000043B2](../SoundLooping/43B2.md)
Marker	|StringId	|
