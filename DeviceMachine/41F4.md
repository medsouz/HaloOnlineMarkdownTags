...
**Name:** ```objects\levels\multi\s3d_turf\fabric_04_moving\fabric_04_moving```
...
BoundingRadius	|Single	|6.169217
BoundingOffset	|RealPoint3d	|{ X: 0.3020895, Y: -0.5034857, Z: -2.560359 }
...
Model	|CachedTagInstance (Model)	|[[0x43B6] 0x000043B6](../Model/43B6.md)
