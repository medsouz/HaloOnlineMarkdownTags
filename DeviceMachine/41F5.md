...
**Name:** ```objects\levels\multi\s3d_turf\fabric_15_moving\fabric_15_moving```
...
BoundingRadius	|Single	|3.36928
BoundingOffset	|RealPoint3d	|{ X: -0.2755759, Y: -2.176617, Z: -1.675019 }
...
Model	|CachedTagInstance (Model)	|[[0x43B9] 0x000043B9](../Model/43B9.md)
