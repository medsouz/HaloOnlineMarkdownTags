...
**Name:** ```objects\levels\ui\mainmenu\menu_elevator_01\menu_elevator_01```
...
BoundingRadius	|Single	|3.967866
BoundingOffset	|RealPoint3d	|{ X: 36.38084, Y: 24.33187, Z: 12.91605 }
...
Model	|CachedTagInstance (Model)	|[[0x2D68] 0x00002D68](../Model/2D68.md)
...
PositionTransitionTime	|Single	|0.1071432
...
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x2D69] 0x00002D69](../SoundLooping/2D69.md)
Marker	|StringId	|elevator
