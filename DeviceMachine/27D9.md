...
**Name:** ```objects\levels\ui\mainmenu\menu_crane\menu_crane```
...
BoundingRadius	|Single	|46.80598
BoundingOffset	|RealPoint3d	|{ X: 0.01518679, Y: -0.01182365, Z: 7.92238 }
...
Model	|CachedTagInstance (Model)	|[[0x2D39] 0x00002D39](../Model/2D39.md)
...
PositionTransitionTime	|Single	|0.01666667
PositionAccelerationTime	|Single	|0.03333334
...
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x2D3A] 0x00002D3A](../SoundLooping/2D3A.md)
Marker	|StringId	|pos
