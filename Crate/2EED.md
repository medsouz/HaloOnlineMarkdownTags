...
**Name:** ```objects\multi\box_xxxl\box_xxxl```
...
BoundingRadius	|Single	|0.05156838
BoundingOffset	|RealPoint3d	|{ X: -2.700835E-05, Y: 0.006049804, Z: 0 }
...
Model	|CachedTagInstance (Model)	|[[0x3440] objects\multi\box_xxxl\box_xxxl](../Model/3440.md)
