...
**Name:** ```objects\gear\human\military\crate_packing_giant\crate_packing_giant_mp```
...
Model	|CachedTagInstance (Model)	|[[0x32A5] objects\gear\human\military\crate_packing_giant\crate_packing_giant](../Model/32A5.md)
...
Unknown	|Int16	|0
Offset	|RealPoint3d	|{ X: 0, Y: 0, Z: 0.45 }
Radius	|Single	|0.7
