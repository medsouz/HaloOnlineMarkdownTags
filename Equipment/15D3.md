...
Model	|CachedTagInstance (Model)	|[[0x19A5] objects\equipment\superflare\superflare](../Model/19A5.md)
...
CreationEffect	|CachedTagInstance (Effect)	|[[0x19A6] 0x000019A6](../Effect/19A6.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x19A7] 0x000019A7](../Effect/19A7.md)
Marker	|StringId	|
...
---	|---	|---	|
AtlasFlags	|Enum (AtlasFlagsValue)	|null
Attachment2	|CachedTagInstance (Light)	|[[0x19A8] 0x000019A8](../Light/19A8.md)
Marker	|StringId	|bomb_light
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
PrimaryScale	|StringId	|
SecondaryScale	|StringId	|
...
---	|---	|---	|
AtlasFlags	|Enum (AtlasFlagsValue)	|null
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x19A9] 0x000019A9](../SoundLooping/19A9.md)
Marker	|StringId	|
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
PrimaryScale	|StringId	|
...
SelfDestructionTime	|Single	|6.5
Unknown2	|UInt32	|0
Unknown3	|UInt32	|0
