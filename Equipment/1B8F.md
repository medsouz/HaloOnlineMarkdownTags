...
**Name:** ```objects\powerups\unsc_ammo_small\unsc_ammo_small```
...
Model	|CachedTagInstance (Model)	|[[0x1BB0] (objects\powerups\h_ammo_crage_sm\h_ammo_crage_sm)](../Model/1BB0.md)
