...
**Name:** ```objects\equipment\jammer_equipment\jammer_equipment```
...
Model	|CachedTagInstance (Model)	|[[0x18A9] objects\equiptment\jammer_equipment\jammer_equipment](../Model/18A9.md)
