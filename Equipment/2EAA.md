...
**Name:** ```objects\multi\powerups\powerup_blue\powerup_blue```
...
Model	|CachedTagInstance (Model)	|[[0x319F] 0x0000319F](../Model/319F.md)
...
PickedUpMessage	|StringId	|powerup_pickup_blue
...
PickupSound	|CachedTagInstance (Sound)	|[[0x1962] 0x00001962](../Sound/1962.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x31A0] 0x000031A0](../Effect/31A0.md)
