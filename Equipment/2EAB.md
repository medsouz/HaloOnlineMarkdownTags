...
**Name:** ```objects\multi\powerups\powerup_red\powerup_red```
...
Model	|CachedTagInstance (Model)	|[[0x31AC] 0x000031AC](../Model/31AC.md)
...
PickedUpMessage	|StringId	|powerup_pickup_red
...
PickupSound	|CachedTagInstance (Sound)	|[[0x31AF] 0x000031AF](../Sound/31AF.md)
...
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x31AD] 0x000031AD](../SoundLooping/31AD.md)
Marker	|StringId	|
...
---	|---	|---	|
AtlasFlags	|Enum (AtlasFlagsValue)	|null
Attachment2	|CachedTagInstance (Effect)	|[[0x31AE] 0x000031AE](../Effect/31AE.md)
Marker	|StringId	|
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
