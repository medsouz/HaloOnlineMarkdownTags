...
Model	|CachedTagInstance (Model)	|[[0x06B2] objects\weapons\grenade\firebomb_grenade\firebomb_grenade_equipment](../Model/06B2.md)
...
DetonationDamageEffect	|CachedTagInstance (DamageEffect)	|[[0x06B3] 0x000006B3](../DamageEffect/06B3.md)
DetonationDelayMin	|Single	|0.4
DetonationDelayMax	|Single	|0.8
DetonatingEffect	|CachedTagInstance	|null
DetonationEffect	|CachedTagInstance (Effect)	|[[0x06B4] 0x000006B4](../Effect/06B4.md)
