...
**Name:** ```objects\powerups\unsc_ammo_large\unsc_ammo_large```
...
Model	|CachedTagInstance (Model)	|[[0x1B9C] (objects\powerups\h_ammo_crage_lg\h_ammo_crage_lg)](../Model/1B9C.md)
