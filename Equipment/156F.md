...
**Name:** ```objects\equipment\reactivearmor_equipment\reactivearmor_equipment```
...
Model	|CachedTagInstance (Model)	|[[0x1B2E] 0x00001B2E](../Model/1B2E.md)
...
ReactiveArmor	|TagBlock (ReactiveArmor)	|[1](#reactivearmor)
...
EmptySound	|CachedTagInstance (Sound)	|[[0x1B2F] 0x00001B2F](../Sound/1B2F.md)
ActivationEffect	|CachedTagInstance (Effect)	|[[0x1B30] 0x00001B30](../Effect/1B30.md)
