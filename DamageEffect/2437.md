...
**Name:** ```objects\weapons\damage_effects\clang_melee```
...
DamageResponse	|CachedTagInstance (DamageResponseDefinition)	|[[0x244B] 0x0000244B](../DamageResponseDefinition/244B.md)
Duration	|Single	|0.4
