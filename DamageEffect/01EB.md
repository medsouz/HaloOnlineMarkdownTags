...
**Name:** ```globals\collision_damage\landing_hard```
...
DamageResponse	|CachedTagInstance (DamageResponseDefinition)	|[[0x13BB] 0x000013BB](../DamageResponseDefinition/13BB.md)
Duration	|Single	|0
