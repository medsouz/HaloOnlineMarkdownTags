...
BoundingOffset	|RealPoint3d	|{ X: 0.07, Y: 0, Z: 0 }
...
Model	|CachedTagInstance (Model)	|[[0x1C96] objects\weapons\support_high\rocket_launcher\rocket_launcher](../Model/1C96.md)
...
PickupMessage	|StringId	|rl_pickup
SwapMessage	|StringId	|rl_swap
PickupOrDualWieldMessage	|StringId	|
SwapOrDualWieldMessage	|StringId	|
PickedUpMessage	|StringId	|rl_picked_up
SwitchToMessage	|StringId	|rl_switch_to
SwitchToFromAiMessage	|StringId	|rl_swap_ai
...
CampaignGroundScale	|Single	|1.4
MultiplayerGroundScale	|Single	|1.4
...
MagnificationBounds	|Bounds`1	|{ Lower: 1.8, Upper: 1.8 }
...
ZoomInSound	|CachedTagInstance (Sound)	|[[0x1C9A] sound\weapons\rocket_launcher\rocket_launcher_zoom_in](../Sound/1C9A.md)
ZoomOutSound	|CachedTagInstance (Sound)	|[[0x1C9B] sound\weapons\rocket_launcher\rocket_launcher_zoom_out](../Sound/1C9B.md)
...
HudInterface	|CachedTagInstance (ChudDefinition)	|[[0x1C9F] ui\chud\rocket](../ChudDefinition/1C9F.md)
...
Attachment2	|CachedTagInstance (Light)	|[[0x1C98] objects\weapons\support_high\rocket_launcher\fx\firing](../Light/1C98.md)
...
Name	| Type	| Value
---	|---	|---	|
FirstPersonModel	|CachedTagInstance (RenderModel)	|[[0x1C9C] objects\weapons\support_high\rocket_launcher\fp_rocket_launcher\fp_rocket_launcher](../RenderModel/1C9C.md)
FirstPersonAnimations	|CachedTagInstance (ModelAnimationGraph)	|[[0x1C9D] objects\characters\masterchief\fp\weapons\support_high\fp_rocket_launcher\fp_rocket_launcher](../ModelAnimationGraph/1C9D.md)
...
---	|---	|---	|
FirstPersonModel	|CachedTagInstance (RenderModel)	|[[0x1C9C] objects\weapons\support_high\rocket_launcher\fp_rocket_launcher\fp_rocket_launcher](../RenderModel/1C9C.md)
FirstPersonAnimations	|CachedTagInstance (ModelAnimationGraph)	|[[0x1C9E] objects\characters\dervish\fp\weapons\support_high\fp_rocket_launcher\fp_rocket_launcher](../ModelAnimationGraph/1C9E.md)
...
RoundsTotalInitial	|Int16	|4
RoundsTotalMaximum	|Int16	|8
RoundsTotalLoadedMaximum	|Int16	|2
MaximumRoundsHeld	|Int16	|6
Unknown	|Int16	|0
ReloadTime	|Single	|5
RoundsReloaded	|Int16	|2
Unknown2	|Int16	|0
...
Name	| Type	| Value
---	|---	|---	|
Rounds0ForMax	|Int16	|2
Unknown	|Int16	|0
Equipment	|CachedTagInstance (Equipment)	|[[0x1CA0] objects\powerups\rocket_launcher_ammo\rocket_launcher_ammo](../Equipment/1CA0.md)
...
Unknown	|Int16	|0
AutofireTime	|Single	|0.2
AutofireThrow	|Single	|0.75
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x15C9] objects\weapons\support_high\rocket_launcher\projectiles\rocket](../Projectile/15C9.md)
...
FiringEffect2	|CachedTagInstance (Effect)	|[[0x1CA1] objects\weapons\support_high_rocket_launcher\fx\firing](../Effect/1CA1.md)
...
FiringResponse	|CachedTagInstance (DamageResponseDefinition)	|[[0x1CA2] globals\damage_responses\trigger_rocket](../DamageResponseDefinition/1CA2.md)
