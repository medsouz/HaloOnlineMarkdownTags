...
**Name:** ```objects\vehicles\mongoose\weapon\mongoose_horn```
...
Attachment2	|CachedTagInstance (SoundLooping)	|[[0x310D] sounds\vehicles\mongoose\mongoose_horn\mongoose_horn](../SoundLooping/310D.md)
Marker	|StringId	|engine
ChangeColor	|Enum (ChangeColorValue)	|null
Unknown	|Int16	|0
PrimaryScale	|StringId	|primary_rate_of_fire
