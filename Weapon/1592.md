...
**Name:** ```objects\weapons\pistol\excavator\excavator_v6```
...
Model	|CachedTagInstance (Model)	|[[0x2407] objects\weapons\pistol\excavator\excavator_v6](../Model/2407.md)
...
PickupMessage	|StringId	|ex_pickup
SwapMessage	|StringId	|ex_swap
PickupOrDualWieldMessage	|StringId	|ex_dual
SwapOrDualWieldMessage	|StringId	|ex_dual_swap
PickedUpMessage	|StringId	|ex_picked_up
SwitchToMessage	|StringId	|ex_switch_to
SwitchToFromAiMessage	|StringId	|ex_swap_ai
...
_1stHitDamage	|CachedTagInstance (DamageEffect)	|[[0x2408] 0x00002408](../DamageEffect/2408.md)
...
WeaponSwitchReadySpeed0Default	|Single	|1
AutoaimAngle	|Angle	|{ Degrees: 8, Radians: 0.1396263 }
AutoaimRangeLong	|Single	|7
AutoaimRangeShort	|Single	|3.5
AutoaimSafeRadius	|Single	|0
MagnetismAngle	|Angle	|{ Degrees: 16, Radians: 0.2792527 }
MagnetismRangeLong	|Single	|7
MagnetismRangeShort	|Single	|3.5
...
HudInterface	|CachedTagInstance (ChudDefinition)	|[[0x2409] ui\chud\excavator_v6](../ChudDefinition/2409.md)
...
ExportName	|StringId	|active_flare
...
Attachment2	|CachedTagInstance (Light)	|[[0x2089] 0x00002089](../Light/2089.md)
...
Name	| Type	| Value
---	|---	|---	|
FirstPersonModel	|CachedTagInstance (RenderModel)	|[[0x1198] objects\weapons\pistol\excavator\fp_excavator\fp_excavator_v3](../RenderModel/1198.md)
FirstPersonAnimations	|CachedTagInstance (ModelAnimationGraph)	|[[0x208C] objects\characters\masterchief\fp\weapons\pistol\excavator\fp_excavator\fp_excavator](../ModelAnimationGraph/208C.md)
...
Name	| Type	| Value
---	|---	|---	|
FirstPersonModel	|CachedTagInstance (RenderModel)	|[[0x1185] objects\weapons\pistol\excavator\fp_excavator\fp_excavator](../RenderModel/1185.md)
FirstPersonAnimations	|CachedTagInstance (ModelAnimationGraph)	|[[0x208D] objects\characters\dervish\fp\weapons\pistol\excavator\fp_excavator\fp_excavator](../ModelAnimationGraph/208D.md)
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x240A] objects\weapons\pistol\excavator\projectiles\excavator_shard_v6](../Projectile/240A.md)
...
FiringEffect2	|CachedTagInstance (Effect)	|[[0x240B] 0x0000240B](../Effect/240B.md)
