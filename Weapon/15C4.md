...
**Name:** ```objects\weapons\rifle\covenant_carbine\covenant_carbine_v3```
...
Model	|CachedTagInstance (Model)	|[[0x25D4] objects\weapons\rifle\covenant_carbine\covenant_carbine_v3](../Model/25D4.md)
...
HudInterface	|CachedTagInstance (ChudDefinition)	|[[0x25D5] ui\chud\carbine_v3](../ChudDefinition/25D5.md)
...
Name	| Type	| Value
---	|---	|---	|
FirstPersonModel	|CachedTagInstance (RenderModel)	|[[0x10B0] objects\weapons\rifle\covenant_carbine\fp_covenant_carbine\fp_covenant_carbine_v5](../RenderModel/10B0.md)
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x25D6] objects\weapons\rifle\covenant_carbine\projectiles\carbine_slug\carbine_slug_v3](../Projectile/25D6.md)
...
FiringEffect2	|CachedTagInstance (Effect)	|[[0x25D7] 0x000025D7](../Effect/25D7.md)
