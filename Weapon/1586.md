...
**Name:** ```objects\weapons\rifle\battle_rifle\battle_rifle_v2```
...
Model	|CachedTagInstance (Model)	|[[0x236E] objects\weapons\rifle\battle_rifle\battle_rifle_v2](../Model/236E.md)
...
---	|---	|---	|
Flags	|UInt32	|3584
RoundsPerSecondMin	|Single	|7.5
RoundsPerSecondMax	|Single	|7.5
