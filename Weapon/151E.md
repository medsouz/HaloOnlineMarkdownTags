...
Model	|CachedTagInstance (Model)	|[[0x1B80] objects\weapons\rifle\assault_rifle\assault_rifle](../Model/1B80.md)
...
HudInterface	|CachedTagInstance (ChudDefinition)	|[[0x1B8D] ui\chud\assault_rifle](../ChudDefinition/1B8D.md)
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x1B90] objects\weapons\rifle\assault_rifle\projectiles\assault_rifle_bullet](../Projectile/1B90.md)
...
FiringEffect2	|CachedTagInstance (Effect)	|[[0x1B91] 0x00001B91](../Effect/1B91.md)
