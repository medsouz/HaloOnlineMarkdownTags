...
**Name:** ```objects\vehicles\shade\weapon\shade_turret```
...
HudInterface	|CachedTagInstance (ChudDefinition)	|[[0x30A9] ui\chud\v_shade](../ChudDefinition/30A9.md)
...
Attachment2	|CachedTagInstance (Light)	|[[0x30A8] objects\vehicles\phantom\fx\weapon\phantom_turret\firing](../Light/30A8.md)
...
DamageErrorMin	|Single	|1.5
DamageErrorMax	|Single	|3
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x30AA] objects\vehicles\shade\weapon\shade_turret](../Projectile/30AA.md)
...
FiringEffect2	|CachedTagInstance (Effect)	|[[0x30AB] 0x000030AB](../Effect/30AB.md)
