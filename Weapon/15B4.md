...
**Name:** ```objects\vehicles\warthog\turrets\chaingun\weapon\chaingun_turret```
...
Unknown3	|SByte	|0
Unknown4	|Int16	|0
InitialProjectile	|CachedTagInstance (Projectile)	|[[0x251B] objects\vehicles\warthog\turrets\chaingun\weapon\bullet](../Projectile/251B.md)
