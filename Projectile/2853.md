...
**Name:** ```objects\vehicles\pelican\pelican_rocket_pod\weapon\projectiles\pelican_rocket```
...
DetonationDamage	|CachedTagInstance (DamageEffect)	|[[0x285B] 0x0000285B](../DamageEffect/285B.md)
...
FlybyResponse	|CachedTagInstance (Effect)	|[[0x1CBD] 0x00001CBD](../Effect/1CBD.md)
