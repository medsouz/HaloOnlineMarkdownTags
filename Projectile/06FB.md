...
**Name:** ```objects\weapons\grenade\firebomb_grenade\projectiles\tertiary_impact```
...
MaterialEffects	|CachedTagInstance (MaterialEffects)	|[[0x06FC] 0x000006FC](../MaterialEffects/06FC.md)
...
TimerMin	|Single	|3.25
TimerMax	|Single	|3.25
...
Attachment2	|CachedTagInstance (Effect)	|[[0x06FD] 0x000006FD](../Effect/06FD.md)
Marker	|StringId	|
