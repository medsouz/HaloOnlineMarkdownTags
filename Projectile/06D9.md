...
**Name:** ```objects\weapons\grenade\firebomb_grenade\projectiles\primary_impact```
...
MaterialEffects	|CachedTagInstance (MaterialEffects)	|[[0x06DD] 0x000006DD](../MaterialEffects/06DD.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x06DE] 0x000006DE](../Effect/06DE.md)
Marker	|StringId	|
