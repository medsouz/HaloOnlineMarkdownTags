...
**Name:** ```objects\weapons\rifle\dmr\projectiles\dmr_bullet```
...
ImpactDamage	|CachedTagInstance (DamageEffect)	|[[0x1E1F] 0x00001E1F](../DamageEffect/1E1F.md)
...
AirDamageRangeMin	|Single	|25
AirDamageRangeMax	|Single	|50
