...
**Name:** ```objects\weapons\rifle\assault_rifle\projectiles\assault_rifle_bullet```
...
ImpactDamage	|CachedTagInstance (DamageEffect)	|[[0x1BD5] 0x00001BD5](../DamageEffect/1BD5.md)
