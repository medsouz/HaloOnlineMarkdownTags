...
**Name:** ```objects\weapons\turret\plasma_cannon\projectiles\plasma_cannon_bolt```
...
ImpactDamage	|CachedTagInstance (DamageEffect)	|[[0x2537] 0x00002537](../DamageEffect/2537.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x2535] 0x00002535](../Effect/2535.md)
Marker	|StringId	|
