...
**Name:** ```objects\weapons\rifle\battle_rifle\projectiles\battle_rifle_bullet```
...
ImpactDamage	|CachedTagInstance (DamageEffect)	|[[0x1D9D] 0x00001D9D](../DamageEffect/1D9D.md)
