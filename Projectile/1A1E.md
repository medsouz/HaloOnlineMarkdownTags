...
**Name:** ```objects\equipment\autoturret\projectiles\autoturret_beam```
...
ImpactDamage	|CachedTagInstance (DamageEffect)	|[[0x1A33] 0x00001A33](../DamageEffect/1A33.md)
...
Attachment2	|CachedTagInstance (Effect)	|[[0x1A31] 0x00001A31](../Effect/1A31.md)
Marker	|StringId	|
