...
**Name:** ```objects\weapons\rifle\battle_rifle\battle_rifle_v6_scenery```
...
Model	|CachedTagInstance (Model)	|[[0x0FE0] objects\weapons\rifle\battle_rifle\battle_rifle_v6_scenery](../Model/0FE0.md)
