...
**Name:** ```objects\weapons\pistol\magnum\magnum_v1_scenery```
...
Model	|CachedTagInstance (Model)	|[[0x1169] objects\weapons\pistol\magnum\magnum_v1_scenery](../Model/1169.md)
