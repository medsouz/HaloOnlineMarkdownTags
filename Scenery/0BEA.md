...
**Name:** ```objects\weapons\rifle\covenant_carbine\covenant_carbine_v4_scenery```
...
Model	|CachedTagInstance (Model)	|[[0x10AB] objects\weapons\rifle\covenant_carbine\covenant_carbine_v4_scenery](../Model/10AB.md)
